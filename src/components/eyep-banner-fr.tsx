...
export default function ProjectBannerFR ({ projectUrl = "#" }: ProjectBannerProps) {
  return (
    <div className="flex flex-col md:flex-row gap-6 p-6 rounded-xl mx-auto text-white max-w-4xl">
      ...
      <div className="flex flex-col justify-between flex-1">
        {/* Project Label */}
        <div className="mb-2">
          <span className="inline-block bg-yellow-500/20 px-4 py-1 rounded-full text-yellow-400 text-sm font-medium mb-4">Projet en Vedette</span>
        </div>
        ...
        <p className="text-gray-300 mb-6">
          Un pomodoro minimaliste avec un traceur de souris en forme d'œil et un système de mode transparence. Améliorez
          votre productivité avec un outil qui vous aide à rester concentré et à gérer votre temps.
        </p>
