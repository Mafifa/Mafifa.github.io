...
// If you're using react-icons, you can replace these imports
// with the equivalent ones from that library
const ArrowRight = () => (
  <svg
...
export default function TheWayComponent () {
  ...
  // Function to add CSS styles to the head
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white overflow-hidden">
      ...
      >
        ...
        {/* Floating elements - reduced quantity for mobile */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              The secure bridge for file transfers between platforms
            </p>
      ...
      <section id="features" className="py-12 md:py-16 lg:py-20 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 md:mb-16">
            ...
            >
              TheWay offers a complete solution for secure file transfers
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10">
              ...
              >
                Your files remain private and secure throughout the transfer process with end-to-end encryption.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10">
              ...
              >
                Optimized for speed with minimal overhead, allowing efficient transfers even with large files.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10 sm:col-span-2 md:col-span-1">
              ...
              >
                Connect and transfer files seamlessly between different operating systems like Windows, macOS, and
                Linux.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
              ...
              >
                Minimalist and Functional Interface
              </h2>
              <p
              ...
              >
                TheWay is designed with a minimalist approach that prioritizes usability. The intuitive interface allows
                you to transfer files with just a few clicks, without sacrificing security or advanced features.
              </p>
      ...
      <section id="download" className="py-12 md:py-16 lg:py-20 bg-[#252525]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Available for all major platforms. Start transferring files securely today.
            </p>
            ...
            >
              <p>Version 1.2.0 | Updated March 15, 2024</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center">
              ...
              >
                Ready for more secure file transfers?
              </h2>
              <p
              ...
              >
                Join thousands of users who trust TheWay for their daily file transfers.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8">
              ...
              <a
                href="https://mafifa.github.io/en/"
                className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base"
                style={{
                  fontFamily: "'Poppins', sans-serif",
                  lineHeight: '1.6',
          ...
          <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            >
              © 2025 TheWay. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
