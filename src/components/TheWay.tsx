...
// con las equivalentes de esa biblioteca
const ArrowRight = () => (
  <svg
...
export default function TheWayComponent () {
  ...
  // Manejar el scroll para efectos de parallax
  useEffect(() => {
    const handleScroll = () => {
  ...
  // Función para crear un observador de intersección
  ...
  // Calcular opacidad y escala basado en el scroll
  const heroOpacity = Math.max(1 - scrollY / 300, 0)
  const heroScale = Math.max(1 - scrollY / 2000, 0.9)

  // Función para añadir estilos CSS al head
  useEffect(() => {
    ...
    // Añadir Google Fonts si no están ya cargadas
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white overflow-hidden">
      ...
      >
        ...
        {/* Floating elements - reducidos en cantidad para móviles */}
          ...
          >
            <div className="mb-6 md:mb-8 relative animate-fadeIn" style={{ animationDelay: '0.2s' }}>
              <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-3xl overflow-hidden shadow-2xl scale-75 sm:scale-90 md:scale-100">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/icon-KMPognAbukHXdca0ElPp3kHSbiXNqz.png"
                  alt="TheWay Logo"
            ...
            >
              El puente seguro para la transferencia de archivos entre plataformas
            </p>
        ...
        {/* Scroll indicator - oculto en pantallas muy pequeñas */}
        <div
      ...
      <section id="features" className="py-12 md:py-16 lg:py-20 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 md:mb-16">
            ...
            >
              TheWay ofrece una solución completa para la transferencia segura de archivos
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10">
              ...
              >
                Tus archivos permanecen privados y seguros durante todo el proceso de transferencia con encriptación de
                extremo a extremo.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10">
              ...
              >
                Optimizado para velocidad con mínima sobrecarga, permitiendo transferencias eficientes incluso con
                archivos grandes.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-yellow-900/20 transform transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-yellow-900/10 sm:col-span-2 md:col-span-1">
              ...
              >
                Conecta y transfiere archivos sin problemas entre diferentes sistemas operativos como Windows, macOS y
                Linux.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
              ...
              >
                TheWay está diseñado con un enfoque minimalista que prioriza la usabilidad. La interfaz intuitiva
                permite transferir archivos con solo unos pocos clics, sin sacrificar la seguridad o las funcionalidades
                avanzadas.
              </p>
              <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                ...
                <li className="flex items-start">
                  ...
                  >
                    Historial de transferencias integrado
                  </p>
                </li>
              </ul>
            </div>
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-gray-900 rounded-2xl overflow-hidden border border-yellow-500/20 shadow-2xl">
                  {/* App mockup - replace with actual screenshot when available */}
      ...
      <section id="download" className="py-12 md:py-16 lg:py-20 bg-[#252525]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Disponible para todas las plataformas principales. Comienza a transferir archivos de forma segura hoy
              mismo.
            </p>
            ...
            >
              <a
                href="https://github.com/Mafifa/theway/releases/tag/v1.0.6"
            ...
            >
              <p>Versión 1.2.0 | Actualizado el 15 de marzo de 2024</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center">
              ...
              >
                ¿Listo para una transferencia de archivos más segura?
              </h2>
              <p
              ...
              >
                Únete a miles de usuarios que confían en TheWay para sus transferencias de archivos diarias.
              </p>
      ...
      <footer className="py-8 md:py-12 bg-[#1a1a1a] border-t border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            >
              © 2025 TheWay. Todos los derechos reservados.
            </p>
