...
export function AuraBannerEN ({ projectUrl = "#" }: ProjectBannerProps) {
  return (
    <div className="flex flex-col md:flex-row gap-6 p-6 rounded-xl text-white max-w-4xl mx-auto">
      ...
      <div className="flex flex-col justify-between flex-1">
        ...
        <p className="text-gray-300 mb-6">
          A mindful reminder application that displays motivational messages as notifications. Boost your mindfulness
          and stay inspired throughout your day with gentle reminders of your limitless potential.
        </p>
