...
export default function AuraLandingPageES () {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div
        ...
        style={{
          transform: `translateY(${Math.min(scrollY * 0.159, window.innerHeight)}px)`,
        }}
      >
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 pt-44 pb-24">
          <div className="container max-w-6xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              >
                Recordatorios conscientes para tu día a día.
                <span className="block mt-2 text-red-400">Porque tu potencial no tiene límites.</span>
              </motion.p>
              ...
              >
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-sm text-gray-400">Descargar para</div>
                ...
                <div className="relative grid grid-cols-1 bg-gray-900 rounded-xl overflow-hidden border border-gray-800 shadow-2xl">
                  ...
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <div className="text-center p-4">
                      ...
                      <h3 className="text-2xl font-medium mb-6">Interfaz de Usuario Simple</h3>
        ...
        <section className="py-20 px-4 sm:px-6 relative">
          <div className="container max-w-6xl mx-auto relative z-10">
            ...
            >
              Mantente <span className="text-red-500">consciente</span>, mantente{" "}
              <span className="text-red-500">enfocado</span>
            </motion.h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Recordatorios Discretos</h3>
                  <p className="text-gray-400">
                    Notificaciones sutiles que inspiran sin interrumpir tu flujo de trabajo.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Mensajes Motivacionales</h3>
                  <p className="text-gray-400">Frases inspiradoras seleccionadas que te recuerdan tu potencial.</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Funcionamiento en Segundo Plano</h3>
                  <p className="text-gray-400">
                    Se ejecuta silenciosamente mientras te concentras en lo que importa en tu día.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <section id="download" className="py-20 px-4 sm:px-6 relative">
          <div className="container max-w-4xl mx-auto text-center relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">¿Listo para transformar tu día?</h2>
              <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
                Descarga Aura ahora y comienza a recibir recordatorios conscientes que inspiran crecimiento.
              </p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-4">Solo 64-bit</p>
                <a
                  href="#"
        ...
        <footer className="py-8 px-4 sm:px-6 border-t border-gray-800 bg-black relative z-10">
          <div className="container max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              <img src="../../resources/aura-image.png" alt="Logo de Aura" className="w-6 h-6 mr-2" />
