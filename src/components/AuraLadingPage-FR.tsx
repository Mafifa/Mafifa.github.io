      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 pt-44 pb-24">
          <div className="container max-w-6xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              >
                Rappels conscients pour votre quotidien.
                <span className="block mt-2 text-red-400">Parce que votre potentiel est illimité.</span>
              </motion.p>
                ...
                <div className="relative grid grid-cols-1 bg-gray-900 rounded-xl overflow-hidden border border-gray-800 shadow-2xl">
                  ...
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                    <div className="text-center p-4">
                      ...
                      <h3 className="text-2xl font-medium mb-6">Interface Utilisateur Simple</h3>
        ...
        <section className="py-20 px-4 sm:px-6 relative">
          <div className="container max-w-6xl mx-auto relative z-10">
            ...
            >
              Restez <span className="text-red-500">conscient</span>, restez{" "}
              <span className="text-red-500">concentré</span>
            </motion.h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Rappels Discrets</h3>
                  <p className="text-gray-400">
                    Notifications douces qui inspirent sans perturber votre flux de travail.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Messages Motivants</h3>
                  <p className="text-gray-400">
                    Citations inspirantes sélectionnées qui vous rappellent votre potentiel.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900 p-6 rounded-xl border border-gray-800 transition-colors">
                  ...
                  <h3 className="text-xl font-medium mb-2">Fonctionnement en Arrière-plan</h3>
                  <p className="text-gray-400">
                    S'exécute silencieusement pendant que vous vous concentrez sur ce qui compte dans votre journée.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <section id="download" className="py-20 px-4 sm:px-6 relative">
          <div className="container max-w-4xl mx-auto text-center relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Prêt à transformer votre journée ?</h2>
              <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
                Téléchargez Aura maintenant et commencez à recevoir des rappels conscients qui inspirent la croissance.
              </p>
            </motion.div>
        ...
        <footer className="py-8 px-4 sm:px-6 border-t border-gray-800 bg-black relative z-10">
          <div className="container max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              <img src="../../resources/aura-image.png" alt="Logo Aura" className="w-6 h-6 mr-2" />
              <span className="text-gray-400 text-sm">© {new Date().getFullYear()} Aura. Tous droits réservés.</span>
            </div>
