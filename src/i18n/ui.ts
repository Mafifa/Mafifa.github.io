...
export const ui = {
  en: {
    ...
    'site.description': 'Mafifa is a Junior web developer and a System Engineer student',
    'site.im': "Hey, I'm Mafifa",
    'site.work': 'Available to work',
    'site.about': 'Systems Engineering student and Junior Fullstack web developer. Specialized in TypeScript, React, Astro and NextJS bases. With experience in project leadership and optimization of digital experiences.',
  ...
  fr: {
    ...
    'site.description': 'Mafifa est un développeur web junior et un étudiant en ingénierie des systèmes.',
    'site.im': 'Hé, je suis Mafifa',
    'site.work': 'Disponible pour travailler',
    'site.about': "Étudiant en ingénierie des systèmes et développeur web Fullstack junior. Spécialisé dans les bases TypeScript, React, Astro et NextJS. Avec une expérience dans la conduite de projet et l'optimisation des expériences digitales.",
  ...
  es: {
    ...
    'site.description': 'Mafifa es un Desarrollador Web junior y un estudiante de Ingieneria en Sistemas',
